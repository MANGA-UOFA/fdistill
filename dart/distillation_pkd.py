...
class SummarizationDistiller(SummarizationModule):
    ...
    def __init__(self, hparams):
        ...
        self.do_calc_hidden_loss = True#(not self.different_base_models) and hparams.alpha_hid > 0
    ...
    def calc_hidden_loss(attention_mask, hidden_states, hidden_states_T, matches):
        ...
        student_states = student_states / torch.norm(student_states, dim=-1, keepdim=True)
        teacher_states = teacher_states / torch.norm(teacher_states, dim=-1, keepdim=True)
